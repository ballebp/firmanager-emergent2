      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .header .info { font-size: 11px; color: #888; margin-top: 3px; }
          ...
          .stop-number { width: 30px; height: 30px; background: #2563eb; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: bold; font-size: 14px; margin-right: 10px; flex-shrink: 0; }
          .stop-title { font-size: 16px; font-weight: bold; }
          .stop-subtitle { font-size: 14px; color: #333; font-weight: bold; }
          .stop-subtitle .annr { font-size: 16px; color: #000; }
          .stop-subtitle .knr { font-size: 16px; color: #000; }
          ...
          .detail-label { font-size: 8px; color: #666; text-transform: uppercase; margin-bottom: 1px; font-weight: bold; }
          .detail-value { font-size: 10px; font-weight: 500; }
          ...
          .info-box-label { font-size: 9px; font-weight: bold; color: #666; margin-bottom: 3px; text-transform: uppercase; }
          .info-box-value { font-size: 10px; line-height: 1.3; }
          .measurements { margin-top: 12px; padding-top: 10px; border-top: 2px solid #333; }
          .measurements-title { font-size: 11px; font-weight: bold; margin-bottom: 8px; text-transform: uppercase; background: #333; color: white; padding: 4px 8px; display: inline-block; }
          ...
          .measurement-label { font-size: 9px; color: #333; font-weight: bold; }
          ...
          .parts-title { font-size: 10px; font-weight: bold; margin-bottom: 6px; }
          .parts-table { width: 100%; border-collapse: collapse; }
          .parts-table th, .parts-table td { border: 1px solid #999; padding: 4px; text-align: left; font-size: 9px; }
          ...
          .checkbox-item { display: flex; align-items: center; gap: 5px; font-size: 10px; }
          .checkbox { width: 14px; height: 14px; border: 2px solid #333; border-radius: 2px; }
          .notes-row { margin-top: 8px; }
          .notes-label { font-size: 9px; font-weight: bold; margin-bottom: 3px; }
          ...
          .time-km-item { }
          .time-km-label { font-size: 9px; font-weight: bold; }
          .time-km-value { height: 18px; border-bottom: 1px solid #666; margin-top: 2px; }
          .footer { margin-top: 20px; padding-top: 12px; border-top: 2px solid #333; text-align: center; font-size: 9px; color: #666; }
